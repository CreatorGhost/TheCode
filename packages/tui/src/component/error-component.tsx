      ...
      <box width={contentWidth()} flexGrow={1} flexDirection="column" paddingTop={1} paddingBottom={1} gap={1}>
        ...
        <Show when={showFooter()}>
          <box flexDirection="column" alignItems="center" flexShrink={0}>
            ...
            <text fg={colors.muted}>DCode {InstallationVersion}</text>
          </box>
        </Show>
      </box>
    </box>
...
function buildIssueURL(message: string, stack: string) {
  ...
  const url = new URL("https://github.com/CreatorGhost/TheCode/issues/new?template=bug-report.yml")
  ...
  url.searchParams.set(
    "reproduce",
    "Reported automatically from the DCode crash screen. If you can, describe what you were doing when it crashed.",
  )

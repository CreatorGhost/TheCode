...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent DCode from reading sensitive files",
  "Use {highlight}dcode run{/highlight} for non-interactive scripting",
  "Use {highlight}dcode --continue{/highlight} to resume the last session",
  "Use {highlight}dcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}dcode serve{/highlight} for headless API access to DCode",
  "Use {highlight}dcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}dcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}dcode auth list{/highlight} to see all configured providers",
  "Run {highlight}dcode agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}dcode debug config{/highlight} to troubleshoot configuration",
